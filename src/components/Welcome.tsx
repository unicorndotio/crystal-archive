...
export function Welcome({ onFileUpload }: { onFileUpload: (event: React.ChangeEvent<HTMLInputElement>) => void; }) {
  return (
    <div className="rounded-3xl p-[2px] bg-gradient-to-b from-white/20 to-white/5 shadow-2xl">
      <main className="w-full h-full rounded-[1.4rem] bg-white/10 backdrop-blur-xl flex flex-col items-center text-center p-6 sm:p-8 md:p-10">
        ...
        <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <button className="w-full sm:w-auto bg-white/10 hover:bg-white/20 border border-white/20 text-white font-semibold py-3 px-8 rounded-xl transition-colors duration-300">
