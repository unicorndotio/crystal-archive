...
<execution_prompt>
  ...
  **Task 1:** [FIRST_TASK_TITLE]
  ...
  Would you like me to proceed with implementing Task 1? I will follow the execution guidelines in @docs/instructions/execute-tasks.md and focus only on this first task and its subtasks unless you specify otherwise.
...
<standards>
  <follow>
    - @docs/standards/bun-guidelines.md
    - @docs/standards/bun-guidelines.md
    - @docs/PRD.md
  </follow>
  <maintain>
